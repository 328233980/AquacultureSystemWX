...
public interface MedicationMapper {
    ...
    @Insert("INSERT INTO medication (pond_id, medication_date, drug_name, drug_type, dosage, dosage_unit, purpose, " +
            "target_disease, withdrawal_period, withdrawal_end_date, operator, remark, created_at, updated_at) " +
            "VALUES (#{pondId}, #{medicationDate}, #{drugName}, #{drugType}, #{dosage}, #{dosageUnit}, #{purpose}, " +
    ...
    @Update("UPDATE medication SET medication_date = #{medicationDate}, drug_name = #{drugName}, drug_type = #{drugType}, " +
            "dosage = #{dosage}, dosage_unit = #{dosageUnit}, purpose = #{purpose}, target_disease = #{targetDisease}, " +
